         ...
         <table class="variants-table">
            <?php foreach ($data['blockVariants'] as $variant) : ?>
              <?php $count = $variant['count']; ?>
                <tr class="c-variant__row <?php if ($variant['count'] == 0): ?>c-variant__row--not-available<?php endif ?> variant-tr <?php echo !$j++ ? 'active-var' : ''?>" 
                  ...
                  data-count="<?php echo $count; ?>">
                    ...
                    <td class="c-variant__column">
                        <label class="c-form <?php echo !$j++ ? 'active' : ''?>">
                            <input <?php if ($variant['count'] == 0): ?>disabled<?php endif ?> type="radio" id="variant-<?php echo $variant['id']; ?>" data-count="<?php echo $count; ?>" name="variant" value = "<?php echo $variant['id']; ?>" <?php echo !$i++ ? 'checked=checked' : ''?>>

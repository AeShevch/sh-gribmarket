<?php
/**
 * В данным файле находится вёрстка страницы сравнения.
 * Вёрстка блока с количеством товара в сравнении и иконкой, который обычно располагают в шапке сайта,
 * Находится в файле layout_compare.php
 */
mgSEO($data);
$prodIds = array();
$propTable = array();
...
<?php
/**
 * Стандартные стили для страницы сравнения, подключающиеся из движка. Можно отключить.
 */
...
<div class="mg-compare-products">
  ...
  <div class="mg-compare-left-side">
    <?php if(!empty($_SESSION['compareList'])){ ?>
      <?php if(MG::getSetting('compareCategory')!='true'){ ?><h2><?php echo lang('showCompare'); ?>:</h2><?php } ?> 
              ...
              <div class="mg-compare-product-inner">
                <div class="title">
                  <a href="<?php echo $item['link'] ?>" title="<?php echo $item['title'] ?>">
                    <?php echo MG::textMore($item['title'], 35) ?>
                  </a>
                </div>

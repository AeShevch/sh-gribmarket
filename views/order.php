                                    ...
                                    <tr>
                                        ...
                                        <td class="c-table__remove     remove-cell">
                                            <a class="deleteItemFromCart delete-btn" href="<?php echo SITE ?>/cart"
                                               ...
                                               title="<?php echo lang('orderRemoveProduct'); ?>">
                        ...
                        <div class="l-row">
                            ...
                            <div class="l-col min-0--12 min-768--6 min-990--3">
                                ...
                                <div class="delivery-interval" style="display:none; margin-bottom: 20px;">
                                    <div class="c-order__title--small"><?php echo lang('orderDeliveryInterval'); ?>:
                                    </div>
                            ...
                            <div class="l-col min-0--12 min-990--6">
                                ...
                                if (EDITION == 'gipermarket') {
                                    ...
                                    <ul class="c-order__list form-list">
                                        <li class="c-order__list--item"><input type="text" name="email"
                                                                               placeholder="Email"
                                        ...
                                        <div class="c-order__total--row">
                                            <form action="<?php echo SITE ?>/order" method="post" class="checkout-form">
                                                <input type="submit" name="toOrder"
                                                       class="checkout-btn default-btn success btn"

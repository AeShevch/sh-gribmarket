  ...
  <?php if($data['form']):?>
	...
	<form action="<?php echo SITE?>/registration" method="POST">
		<ul class="form-list">
            ...
            <?php
            /**
             * Выводим текстовую капчу, если она включена в настройках и выключена Google Recaptcha
             */
            ...
            <?php
            /**
             * Выводим Google Recaptcha
             * Подробнее - http://wiki.moguta.ru/help/Libraries/MG.html#printReCaptcha
             */
